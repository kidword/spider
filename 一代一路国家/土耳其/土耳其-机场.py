...
lis_name= ['ADA', 'ADF', 'AJI', 'ESB', 'HTY', 'AYT', 'BAL', 'BGG', 'BJV', 'YEI', 'CKZ', 'DNZ', 'DLM', 'DIY', 'EDO', 'EZS', 'ERC', 'ERZ', 'AOE', 'GZT', 'GZP', 'IGD', 'ISE', 'IST', 'SAW', 'ADB', 'KCO', 'KCM', 'KSY', 'KFS', 'ASR', 'KYA', 'KZR', 'MLX', 'MQM', 'MZH', 'MSR', 'NAV', 'OGU', 'SZF', 'GNY', 'SXZ', 'NOP', 'NKT', 'VAS', 'TEQ', 'TJK', 'TZX', 'ECN', 'VAN', 'YKO', 'ONQ']
n = 0
ll = []
