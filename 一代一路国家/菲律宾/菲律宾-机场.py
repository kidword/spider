...
lis_name= ['CRK', 'BCD', 'BSO', 'USU', 'BXU', 'CGY', 'CYP', 'MPH', 'CYZ', 'CEB', 'CBO', 'DVO', 'IAO', 'DPL', 'DGT', 'ENI', 'GES', 'ILO', 'KLO', 'LAO', 'LGP', 'MNL', 'MBT', 'WNP', 'OZC', 'PAG', 'PPS', 'RXS', 'SFS', 'SUG', 'TAC', 'TAG', 'TUG', 'VRC', 'ZAM']
n = 0
ll = []
