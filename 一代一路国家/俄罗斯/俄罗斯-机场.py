...
lis_name= ['ABA', 'DYR', 'AAQ', 'KVK', 'ARH', 'ASF', 'BAX', 'EGO', 'EYK', 'OGZ', 'BQS', 'ODO', 'TGP', 'BTK', 'BZK', 'UUA', 'CSY', 'CEK', 'CEE', 'HTA', 'CKH', 'NER', 'ESL', 'GDZ', 'RGK', 'GRV', 'IAA', 'IKT', 'IWA', 'IJK', 'KGD', 'KLF', 'KZN', 'KEJ', 'KPW', 'KHV', 'HMA', 'KCK', 'KVX', 'KGP', 'KXK', 'KMW', 'KSZ', 'KRR', 'KJA', 'KRO', 'URS', 'KYZ', 'LPK', 'GDX', 'IGT', 'MQF', 'MCX', 'MRV', 'MJZ', 'SVO', 'ZIA', 'CKL', 'DME', 'VKO', 'OSF', 'MMK', 'NBC', 'NYM', 'NAL', 'NNM', 'NJC', 'GOJ', 'NSK', 'NOZ', 'OVB', 'NUX', 'NOJ', 'OHH', 'OMS', 'REN', 'OSW', 'PEZ', 'PEE', 'PKC', 'PES', 'PWE', 'PKV', 'ROV', 'RVI', 'SBT', 'SLY', 'KUF', 'SKX', 'RTW', 'EKS', 'AER', 'OVS', 'LED', 'STW', 'SWT', 'SGC', 'SCW', 'TLK', 'TBW', 'IKS', 'TOF', 'THX', 'TJM', 'PYJ', 'UFA', 'UCT', 'UUD', 'ULY', 'ULV', 'URJ', 'USK', 'VVO', 'VOG', 'VGD', 'VKT', 'VOZ', 'YKS', 'IAR', 'SVX', 'EIK', 'JOK', 'UUS']
n = 0
e_error = 0
ll = []
#错误机场代码
...
for i in lis_name:
    try:
        ...
        # ER_fl出现错误的一些机场代码
        ER_fl = ['ODO', 'TGP', 'CKH', 'IAA', 'IWA', 'KPW', 'KCK', 'KRO', 'IGT', 'NAL', 'PES', 'EKS', 'IKS', 'THX', 'VGD']
        if i in ER_fl:
            S = eval(L)
            flg_code = S['iata']
            # 获取到达机场名称
