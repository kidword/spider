...
lis_name= ['AIP', 'IXA', 'AGX', 'AGR', 'AMD', 'AJL', 'IXD', 'ATQ', 'RDP', 'IXU', 'BUP', 'IXG', 'BLR', 'BHU', 'BHO', 'BBI', 'BHJ', 'BKB', 'IXC', 'MAA', 'COK', 'CJB', 'CDP', 'DED', 'DEL', 'DHM', 'DIB', 'DMU', 'DIU', 'GAY', 'GOI', 'GOP', 'GAU', 'GWL', 'HBX', 'HYD', 'IMF', 'IDR', 'JLR', 'JAI', 'JLG', 'IXJ', 'JGA', 'JDH', 'JRH', 'KNU', 'HJR', 'KLH', 'CCU', 'CCJ', 'KUU', 'IXL', 'LKO', 'LUH', 'IXM', 'IXE', 'BOM', 'MYQ', 'NAG', 'NDC', 'ISK', 'PGH', 'IXT', 'IXP', 'PAT', 'PBD', 'IXZ', 'PNY', 'PNQ', 'RPR', 'RJA', 'RAJ', 'IXR', 'SAG', 'IXS', 'IXB', 'SXR', 'STV', 'TRV', 'TRZ', 'TIR', 'TCR', 'UDR', 'BDQ', 'VNS', 'VGA', 'VTZ']
n = 0
e_error = 0
ll = []
#错误机场代码
...
for i in lis_name:
    try:
        ...
        # ER_fl出现错误的一些机场代码
        ER_fl = ['AIP', 'AGX', 'AGR', 'RDP', 'BHU', 'BHJ', 'DHM', 'DMU', 'DIU', 'GOP', 'JGA', 'KNU', 'HJR', 'LUH', 'MYQ', 'ISK', 'PGH', 'IXT', 'IXP', 'PBD']
        if i in ER_fl:
            S = eval(L)
            flg_code = S['iata']
            # 获取到达机场名称
