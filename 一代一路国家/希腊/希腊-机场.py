...
lis_name= ['AXD', 'JTY', 'ATH', 'CHQ', 'JKH', 'CFU', 'HER', 'JIK', 'IOA', 'KLX', 'JKL', 'AOK', 'KSJ', 'KZS', 'KSO', 'KVA', 'EFL', 'KIT', 'KGS', 'KZI', 'LXS', 'LRS', 'MLO', 'JMK', 'MJT', 'JNX', 'PAS', 'GPA', 'PVK', 'RHO', 'SMI', 'JTR', 'JSH', 'JSI', 'SKU', 'JSY', 'SKG', 'VOL', 'ZTH']
n = 0
ll = []
