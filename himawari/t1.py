...
conf = {
    ...
    'img_url_pattern': 'http://himawari8-dl.nict.go.jp/himawari8/img/D531106/%id/550/coastline/ff0000_%i_%i.png',    # scale, time, row, col
...
'http://himawari8-dl.nict.go.jp/himawari8/img/D531106/2d/550/coastline/00ff00_%i_%i.png'
'http://himawari8-dl.nict.go.jp/himawari8/img/D531106/1d/770/coastline/ffff00_0_0.png '
'http://himawari8-dl.nict.go.jp/himawari8/img/D531106/1d/770/coastline/ff0000_0_0.png '
...
def download(args):
    ...
    for row in range(scale):
        for col in range(scale):
            ...
            url = conf['img_url_pattern'] % (args['scale'], row, col)
            try:
